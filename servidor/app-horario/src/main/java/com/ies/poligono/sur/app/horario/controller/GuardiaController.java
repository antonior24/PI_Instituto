...
public class GuardiaController {
  ...
  public ResponseEntity<GuardiaResponseDTO> registrarGuardia(
      @RequestBody RegistrarGuardiaDTO dto, Principal principal) {
  ...
  public ResponseEntity<List<GuardiaResponseDTO>> obtenerGuardias(
      @RequestParam(required = false) Long idProfesor, Principal principal) {
    ...
    List<GuardiaResponseDTO> guardias =
        guardiaService.obtenerGuardiasPorProfesor(idProfessorToFetch);
  ...
  public ResponseEntity<List<HorarioDisponibleDTO>> obtenerHorariosDisponiblesParaGuardia(
    ...
    List<Horario> horariosGuardia =
        horarioService.obtenerPorProfesor(idProfesorAPedir).stream()
            .filter(
    ...
    java.util.Set<Long> franjasGuardia =
        horariosGuardia.stream()
    ...
    for (Ausencia ausencia : ausencias) {
      ...
      dto.setAsignatura(
          horarioAusente.getAsignatura() != null
  ...
  public ResponseEntity<Void> eliminarGuardia(@PathVariable Long id, Principal principal) {
    try {
      Authentication auth = SecurityContextHolder.getContext().getAuthentication();
      boolean esAdmin =
      ...
      guardiaService.eliminarGuardia(id, idProfesor, esAdmin);
